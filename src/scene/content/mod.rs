...
//!
//! This preference is deliberately narrow for now — a caller cannot yet ask for a specific arrangement of their own.
//! A future version of this crate is expected to let a caller choose the grid shape explicitly; until then, only the
//! common, useful cases are handled.
//!
//! # Formatting
//!
