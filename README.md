...
- `DragOptions::bounds`: clamping a drag to a rectangle at both edges, leaving an unbounded drag unconstrained, and a node clamped to the edge remaining draggable afterward — the exact bug this feature fixes
